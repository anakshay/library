                ...
                <div class="card" style="width: 60rem; ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('review') }}" method="GET" class="pt-4">
                            ...
                            <button type="submit" style="border: unset;  border-bottom:1px solid rgb(27, 227, 234);"> pleas enter the review</button>
                        </form>
                    </div>
                        ...
                        <div style="display: flex;">
                            @for ($i = 1; $i <= $item->rating; $i++)
                                ...
                                <p> <i class="bi bi-star-fill"
                                        style="color: @if ($item->rating < 3)green  @else yellow @endif"></i>
                                </p>
                            @endfor
